...
class Supervizor(models.Model):
    ...
    user = models.OneToOneField(get_user_model(), related_name='supervizor', on_delete=models.CASCADE, verbose_name='Супервайзер')
...
class Agent(models.Model):
    user = models.OneToOneField(get_user_model(), related_name='agent', on_delete=models.CASCADE, verbose_name='Агент')
    ...
    hydra_id_sales = models.CharField(max_length=50,null=False, blank=False, verbose_name=('Гидра_ID'))

    def __str__(self) -> str:
        return f'{self.surname}, {self.user}'
